...
class SectionRegisterForm:
    """allows admin to register sections, it validates, if that section code and name already exists or not, if
    it  exists then proper error message is thrown to let them know that these section already exists. all the validations
    of entry fields are done here for registration form so that in order to add sections all fields are required.
    """
    def __init__(self, wind):
        self.window = wind
        self.window.title('SECTION REGISTRATION FORM - COLLEGE MANAGEMENT SYSTEM')
        ...
        self.txt = "Section Registration Form"
        self.count = 0
        self.text = ''
        ...
        self.section_frame = LabelFrame(self.reg_frame, text="Section Details", bg="white", fg="#4f4e4d", height=380,
                                        width=800, borderwidth=2.4,
                                        font=("yu gothic ui", 13, "bold"))
        self.section_frame.config(highlightbackground="red")
        self.section_frame.place(x=100, y=170)
        ...
        self.section_code_label = Label(self.section_frame, text="Section Code ", bg="white", fg="#4f4e4d",
                                        font=("yu gothic ui", 13, "bold"))
        self.section_code_label.place(x=160, y=50)

        self.section_code_entry = Entry(self.window, highlightthickness=0, relief=FLAT, bg="white", fg="#6b6a69",
                                        font=("yu gothic ui semibold", 12))
        self.section_code_entry.place(x=405, y=277, width=340)  # trebuchet ms

        self.section_code_line = Canvas(self.window, width=340, height=1.5, bg="#bdb9b1", highlightthickness=0)
        self.section_code_line.place(x=405, y=299)

        # ========================================================================
        # ===========================Section Name==================================
        # ========================================================================

        self.section_name_label = Label(self.section_frame, text="Section Name ", bg="white", fg="#4f4e4d",
                                        font=("yu gothic ui", 13, "bold"))
        self.section_name_label.place(x=160, y=100)

        self.section_name_entry = Entry(self.window, highlightthickness=0, relief=FLAT, bg="white", fg="#6b6a69",
                                        font=("yu gothic ui semibold", 12))
        self.section_name_entry.place(x=410, y=327, width=335)  # trebuchet ms

        self.section_name_line = Canvas(self.window, width=335, height=1.5, bg="#bdb9b1", highlightthickness=0)
        self.section_name_line.place(x=410, y=349)
        ...
        self.section_capacity_label = Label(self.section_frame, text="Section Capacity ", bg="white", fg="#4f4e4d",
                                          font=("yu gothic ui", 13, "bold"))
        self.section_capacity_label.place(x=160, y=150)

        self.section_capacity_entry = Entry(self.window, highlightthickness=0, relief=FLAT, bg="white", fg="#6b6a69",
                                         font=("yu gothic ui semibold", 12))
        self.section_capacity_entry.place(x=430, y=377, width=315)  # trebuchet ms

        self.section_capacity_line = Canvas(self.window, width=315, height=1.5, bg="#bdb9b1", highlightthickness=0)
        self.section_capacity_line.place(x=430, y=399)
        ...
        self.submit = Button(self.section_frame, image=self.submit_img,
        ...
        self.clear_button = Button(self.section_frame, image=self.clear_img,
                                   font=("yu gothic ui", 13, "bold"), relief=FLAT, activebackground="white"
        ...
        self.back_button = Button(self.section_frame, image=self.back_img,
                                  font=("yu gothic ui", 13, "bold"), relief=FLAT, activebackground="white"
        ...
        self.exit_button = Button(self.section_frame, image=self.exit_img,
                                  font=("yu gothic ui", 13, "bold"), relief=FLAT, activebackground="white"
    ...
    def click_clear_button(self):
        ...
        self.section_code_entry.delete(0, END)
        self.section_capacity_entry.delete(0,END)

    def click_back_button(self):
        """returns ManageSection class if clicked on back button"""
        win = Toplevel()
    ...
    def validation(self):
        ...
        try:
            ...
            for values in data:
                ...
                self.code_list.append(code_data_list)
                name_data_list = values[2]
                self.name_list.append(name_data_list)
        except BaseException as msg:
            print(msg)

        if self.section_code_entry.get() == "" or self.section_name_entry.get() == "" or \
                self.section_capacity_entry.get() == "" :
            messagebox.showwarning("Warning", "All Fields are Required\n Please fill all required fields")

        elif self.section_code_entry.get() in self.code_list:
            messagebox.showerror("Already Exists", f"{self.section_code_entry.get()} Section code Already Exists")
        elif self.section_name_entry.get() in self.name_list:
            messagebox.showerror("Already Exists", f"{self.section_name_entry.get()} Section Already Exists")
    ...
    def click_submit(self):
        ...
        try:
            ...
            obj_section_database = Model_class.section_registration.SectionRegistration(self.section_code_entry.get(),
                                                                                        ...
                                                                                        self.section_capacity_entry.get(),
                                                                                        self.reg_date)
            query = 'insert into section (section_code,section_name,section_capacity,reg_date) values (%s,%s,%s,%s);'

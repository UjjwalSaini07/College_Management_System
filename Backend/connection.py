...
class DatabaseConnection:
    ...
    def file(self):
        ...
        self.len = os.path.getsize("E:\\Python\\College_Management_System\\Frontend\\database_data.txt")
        if self.len > 0:
            f = open("E:\\Python\\College_Management_System\\Frontend\\database_data.txt", "rb")
    ...
    def d_connection(self, host, port, username, password):
        ...
        self.connection = mysql.connector.connect(host="localhost", port=3306, user="root", password="ujjwal2003")
